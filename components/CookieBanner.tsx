...
export default function CookieBanner() {
 ...
 useEffect(() => {
  ...
  console.log('Cookie salvato:', saved)
        ...
        <>
          ...
          <motion.div
            ...
            style={{
              ...
              padding: '2rem',
              boxShadow:
                '0 32px 80px rgba(0,0,0,0.5), 0 0 80px rgba(0,102,255,0.06), inset 0 1px 0 rgba(255,255,255,0.06)',
                ...
                >
                  ...
                  >
                    {[
                      {
                        name: 'cookie_consent',
                        desc: 'Salva la tua preferenza. Scade in 12 mesi.',
                      },
                      {
                        name: 'Nessun tracker',
                        desc: 'Nessun Google Analytics, Facebook Pixel o profilazione.',
                      },
                    ].map(({ name, desc }, i, arr) => (
                      <div
                        key={name}
                        style={{
                          marginBottom: i < arr.length - 1 ? '0.6rem' : 0,
                        }}
                      >
                        <span
                          style={{
            ...
            <div style={{ display: 'flex', gap: '0.7rem', flexWrap: 'wrap' }}>
              <motion.button
                ...
                style={{
                  ...
                  background:
                    'linear-gradient(135deg, #0066FF 0%, #00A3FF 100%)',
                  color: '#fff',
                  border: 'none',
                  borderRadius: '10px',
                  fontFamily: 'var(--font-syne)',
                ...
                whileHover={{
                  y: -2,
                  boxShadow: '0 8px 30px rgba(0,102,255,0.45)',
                }}
                whileTap={{ scale: 0.97 }}
