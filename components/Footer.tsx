  ...
  return (
    <footer style={{
      ...
      <style>{`
        ...
        /* ── Main grid ── */
        .footer-main {
          padding: 3rem clamp(1.2rem, 8%, 8%) 2.5rem;
          display: grid;
        ...
        .footer-right ul { align-items: flex-end; }

        /* ── Bottom bar ── */
        .footer-bottom {
          border-top: 1px solid rgba(0,102,255,0.08);
          padding: 1rem clamp(1.2rem, 8%, 8%);
          display: flex;
      ...
      <div className="footer-main">
        ...
        <div>
          <Image
            ...
            alt="Antonio Russo"
            width={160} height={54}
            style={{ objectFit: 'contain', height: '52px', width: 'auto', marginBottom: '0.9rem' }}
          />
          <p style={{
            fontFamily: 'var(--font-space-mono)', fontSize: '0.68rem',
            color: 'var(--muted)', letterSpacing: '0.05em', lineHeight: 1.7,
          }}>
            ...
            {SOCIAL.map(({ label, href, icon }) => (
              <a key={label} href={href} target="_blank" rel="noopener noreferrer" title={label}
                style={{
                  ...
                  color: 'var(--chrome-dark)', transition: 'all 0.3s', background: 'transparent',
                }}
                onMouseEnter={(e) => {
        ...
        {/* Center: motto */}
        <div className="footer-center" style={{ textAlign: 'center', paddingTop: '0.3rem' }}>
          <p style={{
            fontFamily: 'var(--font-syne)', fontSize: '1rem', fontWeight: 600,
            letterSpacing: '-0.3px', lineHeight: 1.6,
            maxWidth: '280px', margin: '0 auto 1.2rem',
          ...
          <a href="#contact" onClick={(e) => handleScroll(e, '#contact')}
            style={{
              ...
              letterSpacing: '0.1em', color: 'var(--blue-bright)',
              border: '1px solid rgba(0,102,255,0.25)', padding: '0.5rem 1.4rem',
              borderRadius: '50px', transition: 'all 0.3s', display: 'inline-block',
        ...
        <div className="footer-right">
          <nav style={{ marginBottom: '1.8rem' }}>
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.55rem', alignItems: 'flex-end', padding: 0, margin: 0 }}>
              {NAV_LINKS.map(({ href, label }) => (
                <li key={href}>
                  <a href={href} onClick={(e) => handleScroll(e, href)}
                    style={{
                      fontFamily: 'var(--font-space-mono)', fontSize: '0.72rem',
                      letterSpacing: '0.08em', color: 'var(--muted)', transition: 'color 0.25s',
                    }}
      ...
      <div className="footer-bottom">
        <span style={{ fontFamily: 'var(--font-space-mono)', fontSize: '0.6rem', color: 'var(--muted)', letterSpacing: '0.08em' }}>
